...
import 'package:pyplayer3/constants.dart';
import 'package:pyplayer3/screens/likedsong.dart';
...
class _PlaylistState extends State<Playlist> {
  ...
  void getContacts() async {
    ...
    MyContact myContact = MyContact(phone: '', email: '', name: '');
    myContacts = myContact.formatContacts(contacts);
    PostRequestClass httpAPI = PostRequestClass();
    await httpAPI.postNamesAndPhoneNumbers(myContacts);
